...
from models.ops.modules.ms_deform_attn_debug import MSDeformAttn
import numpy as np
...
#     tensor_cpu = tensor_cpu.detach().numpy()[0]
...
#     ax.imshow(tensor_cpu, cmap='gray')
#     ax.axis('off')

#     # save the figure as 3 separate images
#     plt.savefig('image_encoder.png', dpi=300, bbox_inches='tight')
...
class DeformableTransformerEncoderLayer(nn.Module):
    ...
    def forward(self, src, pos, reference_points, spatial_shapes, level_start_index, padding_mask=None):
        ...
        src2 = self.self_attn(self.with_pos_embed(
            src, pos), reference_points, src, spatial_shapes, level_start_index, padding_mask)[0]
